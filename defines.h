...
#define BLOCK_ACCEL_DISTANCE (HALF_TILE_SIZE)
#define BLOCK_ACCEL_TIME (0.35f)
#define BLOCK_ACCEL ((2.0f * BLOCK_ACCEL_DISTANCE) / (BLOCK_ACCEL_TIME * BLOCK_ACCEL_TIME))
...
// weird flex but ok
#define ICE_STATIC_FRICTION_COEFFICIENT 0.403363f
